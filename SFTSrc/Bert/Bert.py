# -*- coding: utf-8 -*-
"""
classification_finetune_bert.py

This script fine-tunes the google-bert/bert-base-uncased model for a binary
...
NEW_MODEL_NAME = "bert-base-can-attack-classifier-experimental"
TIME_GAP_TRAIN = 83.0
TIME_GAP_TEST = 100.0
...
training_arguments = TrainingArguments(
    output_dir="./BERT_Classifier_Experimental",
    num_train_epochs=5,
