# -*- coding: utf-8 -*-
"""
classification_finetune_mobilebert.py

This script fine-tunes the google/mobilebert-uncased model for a binary
...
# This assumes your 'utils.py' file containing SegmentFromFile is in the same directory
...
DATA_DIRECTORY = "/home/lisa/Arupreza/UIDS-II/Split_data/Train/Sil"
VALIDATION_DATA_DIRECTORY = "/home/lisa/Arupreza/UIDS-II/Split_data/Val"
NEW_MODEL_NAME = "mobilebert-can-attack-classifier-experimental"
...
def load_and_process_data(directory, time_gap):
    ...
    for file_path in csv_files:
        ...
        # SegmentFromFile is imported from your utils.py
    ...
    # MODIFICATION 1: Convert numerical pairs into a "language" format
    def format_chunk_to_string(chunk):
        """
        Converts a chunk of numerical pairs into a sentence-like string.
        Example: [[2, 5], [0, 1]] -> "T2 G5 T0 G1"
        """
        tokens = []
        for pair in chunk:
            # pair[0] is Time_Delta_Norm, pair[1] is Intra_ID_Time_Gap_Norm
...
def tokenize_function(examples):
    # Truncate sequences to the model's max supported length
...
# --- 6. Load Base Model with safetensors ---
...
# MODIFICATION 2: Disabled fp16 for training stability with this experimental input
training_arguments = TrainingArguments(
    output_dir="./MobileBERT_Classifier_Experimental",
    num_train_epochs=5,
    ...
    logging_steps=25,
    learning_rate=2e-5,
    # fp16=True, # DISABLED: This can cause 'nan' gradients with non-standard input
    eval_strategy="epoch",
    save_strategy="epoch",
